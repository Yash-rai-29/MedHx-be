...
# Import routers
from patient_service.auth.auth_router import router as auth_router
from patient_service.profile.profile_router import router as profile_router
from patient_service.documents.documents_router import router as documents_router
...
def create_app() -> FastAPI:
    app = FastAPI(
        title="AI Health Companion — Patient Backend",
        description="FastAPI service serving Patient mobile applications",
        version="1.0.0"
    )
    ...
    app.include_router(profile_router, prefix="/profile", tags=["Profile & Vitals"])
    app.include_router(documents_router, prefix="/documents", tags=["Medical Documents"])
...
<head>
    ...
    <title>AI Health Companion — Patient Backend</title>

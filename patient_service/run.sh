...
PUBSUB_VERIFICATION_SECRET=PUBSUB_VERIFICATION_SECRET:latest,\
...
CLOUD_TASKS_QUEUE_NAME=notification-queue,\
ACCOUNT_DELETION_QUEUE_NAME=account-deletion-queue,\
...
ALLOWED_ORIGINS=https://medhx-ai.vercel.app https://medhx.web.app https://medhx.firebaseapp.com"
